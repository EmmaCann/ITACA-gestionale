...
const staff = [
        ...
        bio: (
            <>
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>
                        Esperta in diagnosi e trattamento dei disturbi
                        alimentari
                    </li>
                </ul>
                <p className="mt-2">
                    Opera con impegno nel settore dell’infanzia e adolescenza,
                    collaborando con scuole e istituti di formazione sulla
                    salute mentale.
                </p>
            </>
        ),
    },
    {
        ...
        bio: (
            <>
                <p>
                    Il Dott. Giorgio La Manna è logopedista presso il Centro
                    Itaca. Ha conseguito la laurea triennale e magistrale in
                    Logopedia, abilitato come terapista PROMPT e OMT.
                </p>
                <p className="font-semibold mt-2">Aree di intervento:</p>
                <ul className="list-disc pl-6">
                    <li>
                        Disturbi del Neurosviluppo, come difficoltà, ritardi e
    ...
    },
    {
        ...
        bio: (
            <>
                <p>
                    Ha conseguito la laurea magistrale in Scienze riabilitative
                    delle professioni sanitarie.
                </p>
                <p className="font-semibold mt-2">Ha conseguito:</p>
                <ul className="list-disc pl-6">
                    <li>
                        Master in “Diagnosi e trattamento dei Disturbi
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>
                        Progettazione di interventi di educazione alla salute
                    </li>
                </ul>
                <p className="mt-2">
                    Lavora con passione da anni nel settore dell'infanzia e
                    dell'adolescenza.
                </p>
            </>
        ),
    },
    {
        ...
        bio: (
            <>
                <p>
                    Tecnico della riabilitazione psichiatrica e Psicomotricista
                    funzionale, con laurea magistrale in Scienze riabilitative
                    delle professioni sanitarie.
                </p>
                <p className="font-semibold mt-2">Aree di intervento:</p>
                <ul className="list-disc pl-6">
                    ...
                    <li>
                        Stimolazione delle funzioni di veglia e di relazione
                    </li>
        ...
        bio: (
            <>
                <ul className="list-disc pl-6">
                    ...
                    <li>
                        Specializzata con Master in ABA (Applied Behavior
                        Analysis)
                    </li>
                    <li>
                        Formata nel trattamento dei disturbi dell’età evolutiva
                    </li>
                </ul>
                <p className="font-semibold mt-2">Aree di intervento:</p>
                <ul className="list-disc pl-6">
    ...
    {
        key: "paola-morgante",
        name: "Dott.ssa Paola Morgante",
        role: "Logopedista",
        gender: "F",
        img: "/images/staff/paola-morgante.jpeg",
        bio: (
            <>
                <ul className="list-disc pl-6">
                    <li>
                        Logopedista laureata presso l’Università degli Studi di
                        Catania
                    </li>
                    <li>
                        Attualmente iscritta alla Laurea Magistrale in Scienze
                        Riabilitative delle Professioni Sanitarie
                    </li>
                    <li>Formazione specifica in Oral Motor Therapy</li>
                    <li>Formata nell’utilizzo dello strumento Novafon</li>
                    <li>
                        Esperta nella valutazione, trattamento e riabilitazione
                        dei disturbi del linguaggio, della comunicazione e della
                        deglutizione
                    </li>
                    <li>
                        Esperienza con bambini con disturbi del neurosviluppo e
                        con adulti con disfonie, afasia o patologie
                        neurodegenerative
                    </li>
                </ul>
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>Difficoltà linguistiche e deglutitorie</li>
                    <li>
                        Disturbi del linguaggio e della comunicazione in età
                        evolutiva
                    </li>
                    <li>Disturbi della voce e della deglutizione</li>
                    <li>Afasie</li>
                    <li>
                        Disturbi conseguenti a patologie neurologiche e
                        neurodegenerative
                    </li>
                </ul>
            </>
                ...
                <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="p-6 md:p-8">
                        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-6">
                            ...
                            <div>
                                <h1 className="text-3xl font-marcellusSC text-gray-800">
                                    Il nostro staff
                                </h1>
                                <p className="text-gray-600 text-sm">
                                    Professionisti qualificati al servizio della
                                    crescita dei bambini e delle famiglie.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="border-t border-gray-100 bg-bgContainer p-6">
                        <div className="max-w-6xl mx-auto text-sm text-gray-600">
                            ...
                            <div className="mt-4 rounded-lg overflow-hidden flex justify-center">
                                <img
                                    src="/images/staff/staff-completo.jpg"
                                    alt="staff completo"
                                    className="w-full max-w-[480px] h-auto object-cover rounded-lg shadow"
                                />
                            </div>
                        </div>
                    </div>
