...
import ModalContentAggiungiAppuntamento from "./modalContentAggiungiAppuntamento.jsx";
...
export const FAB = () => {
    ...
    return (
        <>
            ...
            {/* Modal per aggiunta appuntamento */}
            <CustomModal
                isOpen={modalTipoAppuntamento}
                onRequestClose={() => setModalTipoAppuntamento(false)}
                title="Nuovo Appuntamento"
            >
                <ModalContentAggiungiAppuntamento
                    onClose={() => setModalTipoAppuntamento(false)}
                    onSubmit={(data) =>
                        console.log("Appuntamento creato:", data)
                    }
                />
            </CustomModal>
        </>
